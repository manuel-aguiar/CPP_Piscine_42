...
template <
	typename Iterator
>
static Iterator& advanceeee(Iterator& iter, int n)
{
	typename std::iterator_traits<Iterator>::iterator_category category;
...
template <
	typename Iterator
>
static Iterator& advanceeee(Iterator& iter, int n, std::bidirectional_iterator_tag)
{
	if (n > 0)
	{
		while (n--)
...
template <
	typename Iterator
>
static Iterator& advanceeee(Iterator& iter, int n, std::forward_iterator_tag)
{
	while (n--)
		++iter;
	return (iter);
