...
void    Harl::debug(void)
{
    ...
    std::cout << "Não podia pedir mais, incrível!" << std::endl;
}
...
void    Harl::warning(void)
{
    ...
    std::cout << "não pode fazer trafulhices" << std::endl;
}

void    Harl::error(void)
{
    std::cout << "ACABOU-SE!!! Vamos lá falar com o chefe do chefe do chefe do chefe ";
    std::cout << "do chefe do chefe do chefe para demitir a PJ INTEIRA!!" << std::endl;
}
